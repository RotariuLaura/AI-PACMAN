    ...
    def getAction(self, gameState):
        ...
        def minimax(state, depth, agentIndex):
            ...
            for action in legalActions:
                ...
                value, _ = minimax(successor, depth - 1, (agentIndex + 1) % state.getNumAgents())
    ...
    def getAction(self, gameState: GameState):
        ...
        def expectimax(state, depth, agentIndex):
            ...
            if agentIndex == 0:  # Pacman's turn
                ...
                for action in state.getLegalActions(agentIndex):
                    successor = state.generateSuccessor(agentIndex, action)
                    value, _ = expectimax(successor, depth - 1, (agentIndex + 1) % state.getNumAgents())
                    if value > bestValue:
                        bestValue = value
                        bestAction = action
                return bestValue, bestAction
        ...
        _, bestAction = expectimax(gameState, self.depth * gameState.getNumAgents(), 0)
        return bestAction
